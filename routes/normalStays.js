...
const RentShort = require("../models/RentShort");
...
// Get recent short-term stays (limited to 5)
...
// Get a single short-term stay by ID
router.get("/:id", async (req, res) => {
    try {
        ...
        if (!rent) {
            return res
                .status(404)
                .json({ message: "Short-term stay not found" });
        }
...
// Remove like from a short-term stay
